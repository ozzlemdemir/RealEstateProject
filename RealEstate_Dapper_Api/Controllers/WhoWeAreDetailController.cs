...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    public class WhoWeAreDetailController : ControllerBase
    {
        ...
        public WhoWeAreDetailController(IWhoWeAreDetailRepository categoryRepository)
        {
            _whoWeAreDetailRepository = categoryRepository;
        }
        [HttpGet]
        ...
        {
            _whoWeAreDetailRepository.CreateWhoWeAre(createWhoWeAreDetailDto);
